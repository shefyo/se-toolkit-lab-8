...
- [`contributing/conventions/agents/skills.md`](skills.md) — skill file structure, frontmatter fields, agent-neutral language, body sections

## When editing `contributing/conventions/`

Read before making changes:

- [`contributing/conventions/conventions.md`](../conventions.md) — conventions for writing conventions
