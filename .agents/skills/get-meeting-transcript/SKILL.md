...
2. Read [`contributing/conventions/meeting-report.md`](../../../contributing/conventions/meeting-report.md) and locate the **Transcript** path in the File locations section. Substitute actual N and M values, then strip the filename to get the transcripts directory.
