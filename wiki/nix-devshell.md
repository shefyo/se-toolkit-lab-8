...
It provides a set of [tools](./package-manager.md#tool) and [environment variables](./environments.md#environment-variable) that are available only inside the [shell](./shell.md#what-is-shell) session.
