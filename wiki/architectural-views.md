...
We use [`PlantUML`](./visualize-architecture.md#plantuml) [component diagrams](https://plantuml.com/component-diagram).
...
We use [`PlantUML`](./visualize-architecture.md#plantuml) [sequence diagrams](https://plantuml.com/sequence-diagram).
...
We use [`PlantUML`](./visualize-architecture.md#plantuml) [deployment diagrams](https://plantuml.com/deployment-diagram).
