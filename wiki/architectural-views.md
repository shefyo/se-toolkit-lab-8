...
We use [`PlantUML`](./visualize-architecture.md#plantuml) for [component diagrams](https://plantuml.com/component-diagram).
...
We use [`PlantUML`](./visualize-architecture.md#plantuml) for drawing [sequence diagrams](https://plantuml.com/sequence-diagram).
...
We use [`PlantUML`](./visualize-architecture.md#plantuml) for [deployment diagrams](https://plantuml.com/deployment-diagram).
