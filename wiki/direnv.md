...
`direnv` is a [shell](./shell.md#what-is-shell) extension that automatically loads and unloads [environment variables](./environments.md#environment-variable) when you enter or leave a [directory](./file-system.md#directory).
