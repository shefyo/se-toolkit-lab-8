...
5. Read the convention files referenced in the report header so every fix is grounded in the actual convention text:
   - **For `lab/tasks/` files:**
     - [`contributing/conventions/common.md`](../../../contributing/conventions/common.md)
     - [`contributing/conventions/tasks.md`](../../../contributing/conventions/tasks.md)
   - **For `wiki/` files:**
     - [`contributing/conventions/common.md`](../../../contributing/conventions/common.md)
     - [`contributing/conventions/wiki.md`](../../../contributing/conventions/wiki.md)
