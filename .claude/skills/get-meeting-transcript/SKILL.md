...
2. Run `nix develop --command process-meeting-transcript instructors/meetings/week-N/meeting-M/transcripts` (substituting the actual values of N and M). Pass through any `--merge` flags as-is.
